...
export default function SelectStartLocation() {
  const router = useRouter()
  const [location, setLocation] = useState("شارع الرشيد")
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute top-[60%] left-[30%] z-10">
        <div className="w-6 h-6 bg-[#F5B841] rounded-full flex items-center justify-center">
      ...
      <div className="absolute bottom-[70px] left-0 right-0 z-30">
        <div className="bg-white p-4 rounded-t-xl shadow-lg mb-2">
          ...
          <Button
            ...
            className="w-full bg-[#7DD3D8] hover:bg-[#6bc4c9] text-white rounded-xl h-12 flex items-center justify-between px-4"
          >
            <div className="flex items-center">
              <MapPin className="h-5 w-5 mr-2" />
              <span>١٠ د.ع</span>
            </div>
            <span>تأكيد مبدأ الرحلة</span>
          </Button>
        </div>
      </div>
    </div>
